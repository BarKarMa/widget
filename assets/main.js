...
item00.innerHTML = `<span id="server-messages" style="text-align: center; margin-right: 4% ">Вітаємо вас у контактному центрі! Для зв'язку з оператором надішліть повідомлення.</span>`
